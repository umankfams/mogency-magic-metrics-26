  ...
  return <section id="features" className="py-20 md:py-32 relative overflow-hidden bg-black/30">
      ...
      <div id="features-section" className="section-container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <AnimatedCard key={index} icon={feature.icon} title={feature.title} description={feature.description} delay={100 * index} glowColor={feature.color} />)}
        </div>
      </div>
    </section>;
};

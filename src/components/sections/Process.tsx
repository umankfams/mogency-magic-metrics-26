...
const Process = () => {
  ...
  return <section id="process" className="py-20 pb-44 md:pb-64 bg-black/40 relative overflow-hidden z-10 my-0 md:py-0">
      {/* Background elements */}
      ...
      <div id="process-section" className="section-container relative z-10 my-[46px] py-[113px] bg-black">

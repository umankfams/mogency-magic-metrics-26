...
const Process = () => {
  ...
  const steps = [{
    ...
    icon: <LightbulbIcon size={isMobile ? 16 : 20} />,
    ...
    icon: <PiggyBank size={isMobile ? 16 : 20} />,
    color: "from-mogency-neon-green to-mogency-neon-blue"
  }];
  
  return <section id="process" className="py-12 md:py-20 bg-black/40 relative overflow-hidden z-10">
      {/* Background elements */}
      ...
      <div id="process-section" className="section-container relative z-10">
        <div className="text-center mb-10 md:mb-20">
          <h2 className={cn("section-title", 
            ...
            isMobile ? "text-xl md:text-2xl" : "text-3xl md:text-4xl lg:text-5xl"
          )}>
          ...
          <p className={cn("section-subtitle", 
            ...
            isVisible ? "opacity-100" : "opacity-0",
            isMobile && "text-xs md:text-sm mb-6 md:mb-8"
          )}>
        ...
        <div className={cn("mt-16 md:mt-20 rounded-xl max-w-3xl mx-auto overflow-hidden", "transform transition-all duration-700 delay-600", isVisible ? "opacity-100" : "opacity-0")}>

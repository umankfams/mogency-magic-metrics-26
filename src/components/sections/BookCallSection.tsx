  ...
  return (
    <section id="book-call" className="py-16" ref={sectionRef}>
      <div className="section-container">
        <div className="card-glass p-8 md:p-12 max-w-3xl mx-auto border border-mogency-neon-blue/30 shadow-[0_0_30px_rgba(14,165,233,0.2)]">
          <div className="text-center">
            ...
            <p className={cn(
              "text-lg text-muted-foreground mb-8 transition-all duration-500 delay-100",
              "opacity-0 translate-y-4",
              isIntersecting && "opacity-100 translate-y-0"
            )}>
            ...
            <Button 
              size="lg"
              className={cn(
                "bg-neon-gradient hover:opacity-90 transition-opacity shadow-neon rounded-full px-8 py-6 text-lg transition-all duration-500 delay-200",
                "opacity-0 scale-95",
